...
#define TC1_PIN 20  // Bot Touch
#define TC2_PIN 21  // Top Touch
#define PW_LED_PIN 3
...
public:
  ...
  void updateThemeNumber();
  void updateBrightness();
  void updateWiFi(String ssid, String pwd);
